...
export const SAFE_CREATED = ReactHtmlParser(chrome.i18n.getMessage('safe_created'))
export const SAFE_CREATION = ReactHtmlParser(chrome.i18n.getMessage('safe_creation'))
