...
// -------------------------------------
  ...
  function toggleSettingView (view) {
    ...
    let settingViews = document.querySelectorAll('.overlayPage[data-page]')
  ...
  function closeSettingsView () {
    let backBTNS = document.querySelectorAll('.overlayPageHeader > .btn-back')
    let settingViews = document.querySelectorAll('.overlayPage[data-page]')
  ...
  // ======================================================
    ...
    (function () {
      ...
      let trigger = document.querySelectorAll("#triggerTX-dapp")[0];
      let close = document.querySelectorAll(".extensionTX[data-demo='1'] .topbar > i")[0];
      let reject = document.querySelectorAll(".extensionTX[data-demo='1'] .PageContent .reject")[0];
      let confirm = document.querySelectorAll(".extensionTX[data-demo='1'] .PageContent .confirm")[0];
      ...
      confirm.onclick = function(){
        let state1 = document.querySelectorAll(".extensionTX[data-demo='1'] .PageContent .button-group")[0];
        let state2 = document.querySelectorAll(".extensionTX[data-demo='1'] .PageContent .transactionState")[0];
    ...
    (function () {
      ...
      let trigger = document.querySelectorAll("#triggerTX-confirm")[0];
      let close = document.querySelectorAll(".extensionTX[data-demo='2'] .topbar > i")[0];
      let reject = document.querySelectorAll(".extensionTX[data-demo='2'] .PageContent .reject")[0];
      let confirm = document.querySelectorAll(".extensionTX[data-demo='2'] .PageContent .confirm")[0];
